...
def decisionMaker(H,minimax,depth):
    ...
    if minimax == 0:
        ...
        for i in range(0,9):
            ...
            if boardState[i] == 0:
                boardState[i] = 2
                y = max(value, decisionMaker(boardState, minimax +1, depth + 1))
                if y != value:
                    O = i
                    value = y
            if value == 1:
    ...
    if minimax == 1:
        ...
        for i in range(0,9):
            ...
            if boardState[i] == 0:
                boardState[i] = 1
                y = min(value, decisionMaker(boardState, minimax -1, depth + 1))
                if y != value:
                    O = i
                    value = y
            if value == -1:
